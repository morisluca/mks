    ...
    <UserLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Track all your trading positions</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-card border border-border rounded-xl px-4 py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground">No trades yet. Start by choosing a plan.</p>
          </div>
        ) : (
